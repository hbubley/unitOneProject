...
let $button = $('<button>').html('ENTER').css({'font-size': '12vw', 'letter-spacing': '2%', 'font-family': 'Barrio', 'background-color': 'rgba(244, 244, 244, 0.7)', 'border': 'solid', 'padding': '2%', 'max-width':'60vw',})
